...
const menuItems2 = [
 ...
 const menuItems = [
  {name: "Coconut Creame Pie", calories: 450, price: 14.99, paragraph: "A rich and creamy pie made with a flaky crust, filled with coconut custard, and topped with whipped cream and toasted coconut flakes, pumpkin spice, whole milk, sugar, ", image: "logo/coconut.jpg"}, 
  {name: "Pumpkin Pie", calories: 400, price: 12.99, image: "logo/pumpkin-pie.jpg", paragraph: "A classic dessert made with a spiced pumpkin filling in a flaky pie crust, often served with whipped cream on top, sugar, pumpkin puree, warm spices like cinnamon, nutmeg, and cloves."},
